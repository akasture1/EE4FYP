...
fprintf('[SIM_DDP_AK7213][Sim #3] Increasing number of Speed Levels [l]\n');
%for l = 10:10:Obs*10
for l = vals
    s = (1/l:1/l:1)';
    P = 10*((1/l:1/l:1).^2)';
    ...
    %[aOpt, xOpt, nIter] = DDP_AK7213_V2(n, N, l, m, s, step, P, xBar, ipmTol, ipmMaxIter, solver, solverTol);
    te = toc(ts);
...
title('Function Duration vs Number of Speed Levels [DDP-AK7213-V5-CGS]');
...
title('Number of Iterations vs Number of Speed Levels [DDP-AK7213-V5-CGS]');
xlabel('  Number of Speed Levels');
...
title('Time Per Iteration vs Number of Speed Levels [DDP-AK7213-V5-CGS]');
xlabel('Number of Speed Levels');
ylabel('Time Per Iteration (s)');
grid on

fprintf('Line of Best Fit: (%3.6f)x^(%3.6f) + %3.6f\n', eqn.a, eqn.b, eqn.c);
save('SIM_DDP_AK7213_SIM3')
