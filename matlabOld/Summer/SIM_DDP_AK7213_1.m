...
fprintf('[SIM_DDP_AK7213][Sim #1] Increasing number of Tasks [n]\n');
for n = vals
    xBar = step*rand(n,1);
    ts = tic;
...
title('Function Duration vs Number of Tasks [DDP-AK7213-V5-CGS]');
...
title('Number of Iterations vs Number of Tasks [DDP-AK7213-V5-CGS]');
xlabel('Number of Tasks');
...
title('Time Per Iteration vs Number of Tasks [DDP-AK7213-V5-CGS]');
xlabel('Number of Tasks');
ylabel('Time Per Iteration (s)');
grid on

fprintf('Line of Best Fit: (%3.6f)x^(%3.6f) + %3.6f\n', eqn.a, eqn.b, eqn.c);
save('SIM_DDP_AK7213_SIM1')
