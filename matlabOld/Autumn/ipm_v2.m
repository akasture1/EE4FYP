...
cascadedRs = vertcat(rx(:,1:N), ra, rlambda_hat, rp);
...
%(3,3) E
x=3;y=3;
uBlock(pos(x,1):pos(x,2), pos(y,1):pos(y,2)) = E; 
...
% Add the 2 missing -I matrices in position (5,4) and (4,5) that we skipped
blockdim = sum(dim);
